...
interface ApiCustomField {
  id: number, label: string, section: CRMCustomField['section'], type: CRMCustomField['type'], required: boolean, default_value?: boolean | null, is_business_value?: boolean, visible_when: string,
