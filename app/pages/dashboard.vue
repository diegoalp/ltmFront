<template>
        <header class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <!-- <p class="text-sm uppercase tracking-[0.24em] text-slate-500 dark:text-slate-400">Operação de crédito consignado</p>
            <h1 class="text-2xl font-semibold md:text-3xl priority-color">CRM</h1> -->
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-300">
              Acompanhe propostas, oportunidades, funis e tarefas da operação comercial.
            </p>
          </div>
